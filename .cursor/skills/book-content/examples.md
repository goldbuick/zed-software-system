...
For a full perimeter, repeat for x=0..59, y=0 and y=24, then x=0 and x=59 for y=1..23. See `ops/fixtures/content/templates/demo/pages/title.board.json`.
...
Reference fixtures: `ops/fixtures/lang/coolregionsbow/*.zss` for ZSS patterns to embed in `code` strings.
