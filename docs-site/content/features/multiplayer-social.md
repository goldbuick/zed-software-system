...
| Stream broadcast | Both | Start/stop live stream **out** (IVS / WHIP / YouTube relay). | `#broadcast` |
| Media input | Both | Play WHEP **into** cafe (headed browser sidecar or any WHEP URL). | `#media` |
