...
const DEBUG_SHOW_CODE = zssjsonbool('ZSS_DEBUG_SHOW_CODE')
...
/** Incremental gadget layer rebuild tied to drawallowids. Default off: warm cache can keep dead sprites. */
