...
| Terrain display de-dupe on export | [`boardterrainmap.ts`](../boardterrainmap.ts) — see [boardterrainmap.md](boardterrainmap.md); book exports intern, memoryfs and `#pageexport` strip only, rollback snapshots stay verbatim |
