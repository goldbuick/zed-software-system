...
import { FIRMWARE, createFirmware } from '../firmware'

const shared: STATE = {}

const syncServer = createJsonSyncServer()
...
type GADGET_FIRMWARE = {
  device: DEVICE
  sync: () => void
} & FIRMWARE

export const GadgetFirmware: GADGET_FIRMWARE = {
  device: syncServer.device,
  sync() {
    syncServer.sync(shared)
  },
  ...createFirmware('gadget')
