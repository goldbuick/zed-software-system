...
- \`#agent model\`: menu of \`!runit\` rows to switch preset (current row highlighted); \`#agent model llama|phi|smol|tiny\`: switch ONNX preset (persisted in register storage)
