...
struct OscCfg {
  float phase, width, modfreq, harmonicity, modindex, count, spread,
      partialcount;
  float partials[8];
...
/** Tone-shaped play envelope: linear attack, exponential decay/release
 * (AmplitudeEnvelope defaults). */
struct ZssLinearEnv {
...
struct ZssVoice {
  ...
  float dootprev_a = -1.f, dootprev_d = -1.f, dootprev_s = -1.f,
        dootprev_r = -1.f;
  float algoprev_a = -1.f, algoprev_d = -1.f, algoprev_s = -1.f,
        algoprev_r = -1.f;
