...
- `help/` — Help screens
- `refscroll/` — Reference scrolls as **`.md`** (bundled via `import.meta.glob('./refscroll/**/*.md')`; address `refscroll:<name>` without extension). Full list and gadget routing: [`zss/gadget/docs/gadget-scrolls.md`](../../gadget/docs/gadget-scrolls.md)
