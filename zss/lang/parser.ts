...
class ScriptParser extends CstParser {
  ...
  color = this.RULED('color', () => {
    this.OR([
      ...
      { ALT: () => this.CONSUME(lexer.color_blblack) },
      { ALT: () => this.CONSUME(lexer.color_bldkblue) },
      { ALT: () => this.CONSUME(lexer.color_bldkgreen) },
      { ALT: () => this.CONSUME(lexer.color_bldkcyan) },
      { ALT: () => this.CONSUME(lexer.color_bldkred) },
      { ALT: () => this.CONSUME(lexer.color_bldkpurple) },
      { ALT: () => this.CONSUME(lexer.color_bldkyellow) },
      { ALT: () => this.CONSUME(lexer.color_blltgray) },
      { ALT: () => this.CONSUME(lexer.color_bldkgray) },
      { ALT: () => this.CONSUME(lexer.color_blblue) },
      { ALT: () => this.CONSUME(lexer.color_blgreen) },
      { ALT: () => this.CONSUME(lexer.color_blcyan) },
      { ALT: () => this.CONSUME(lexer.color_blred) },
      { ALT: () => this.CONSUME(lexer.color_blpurple) },
      { ALT: () => this.CONSUME(lexer.color_blyellow) },
      { ALT: () => this.CONSUME(lexer.color_blwhite) },
      { ALT: () => this.CONSUME(lexer.color_blbrown) },
      { ALT: () => this.CONSUME(lexer.color_bldkwhite) },
      { ALT: () => this.CONSUME(lexer.color_blltgrey) },
      { ALT: () => this.CONSUME(lexer.color_blgray) },
      { ALT: () => this.CONSUME(lexer.color_blgrey) },
      { ALT: () => this.CONSUME(lexer.color_bldkgrey) },
      { ALT: () => this.CONSUME(lexer.color_blltblack) },
    ])
  })
