/**
 * CP437 (IBM PC Code Page 437) to Unicode mapping.
 * Used when converting $code (0-255) to display strings for terminals and plain text.
 * The web tilemap uses raw codes as font indices (charset is in CP437 order).
 *
 * Source: Unicode CP437.TXT (Microsoft mapping)
 */
const CP437_TO_UNICODE: readonly number[] = [
  ...
  0x007e, 0x007f /* 128-255: CP437 extended */, 0x00c7, 0x00fc, 0x00e9, 0x00e2,
...
/** Convert CP437 code (0-255) to Unicode character for display. */
export function cp437ToChar(code: number): string {
  if (code >= 0 && code <= 255) {
