...
| `DIR` | IDLE, NORTH, SOUTH, WEST, EAST, BY, AT, FLOW, SEEK, RNDNS, RNDNE, RND, CW, CCW, OPP, RNDP, AWAY, TOWARD, FIND, FLEE, TO, MID, OVER, UNDER, GROUND, WITHIN, AWAYBY, ELEMENTS, SELECT |
