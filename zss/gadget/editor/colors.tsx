...
export const ZSS_COLOR_MAP: Record<number, COLOR> = {
  ...
  [lexer.iseq.tokenTypeIdx ?? 0]: ZSS_TYPE_FLAGMOD,
  [lexer.isnoteq.tokenTypeIdx ?? 0]: ZSS_TYPE_FLAGMOD,
  [lexer.islessthan.tokenTypeIdx ?? 0]: ZSS_TYPE_FLAGMOD,
  [lexer.isgreaterthan.tokenTypeIdx ?? 0]: ZSS_TYPE_FLAGMOD,
  [lexer.islessthanorequal.tokenTypeIdx ?? 0]: ZSS_TYPE_FLAGMOD,
  [lexer.isgreaterthanorequal.tokenTypeIdx ?? 0]: ZSS_TYPE_FLAGMOD,
  ...
  [lexer.command_do.tokenTypeIdx ?? 0]: ZSS_TYPE_KEYWORD,
  [lexer.command_to.tokenTypeIdx ?? 0]: ZSS_TYPE_KEYWORD,
  [lexer.command_done.tokenTypeIdx ?? 0]: ZSS_TYPE_KEYWORD,
