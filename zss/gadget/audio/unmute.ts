...
export function unmute(
  ...
  if (document.hidden !== undefined)
    ...
    pageVisibilityAPI = {
      hidden: 'mozHidden' as any,
      visibilitychange: 'mozvisibilitychange' as any,
    }
  else if ((document as any).msHidden !== undefined)
    pageVisibilityAPI = {
      hidden: 'msHidden' as any,
      visibilitychange: 'msvisibilitychange' as any,
    }
  ...
  function updatePlaybackState(): void {
    ...
    const shouldAllowPlayback: boolean =
      ...
      ((!pageVisibilityAPI || !(document as any)[pageVisibilityAPI.hidden]) && // can be active if no page vis api, or page not hidden
