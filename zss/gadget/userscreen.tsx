...
export function UserScreen({ children }: UserScreenProps) {
  ...
  // Pin char grid to top-left of the view; leftover sub-char pixels fall on
  // the right/bottom edge instead of safe-area-like centered gutters.
  const marginx = 0
  const marginy = 0
