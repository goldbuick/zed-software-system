...
import { readwanixiframehost } from 'zss/feature/wanix/wanixiframehost'
...
export function replywanix(
  ...
  wanix.reply(message, `wanix:${method}`, result)
}
...
export function replywanixerror(
  ...
  wanix.reply(message, `wanix:${method}`, {
