...
|--------|----------------|
| `yarn dev` | Install deps, clear local build outputs, ensure the bundled Vosk speech model, then start the Vite dev server at **https://localhost:7777** (binds `0.0.0.0`). |
