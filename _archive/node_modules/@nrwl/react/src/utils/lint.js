...
exports.createReactEslintJson = exports.extendReactEslintJson = exports.extraEslintDependencies = void 0;
...
const extendReactEslintJson = (json) => {
    ...
    return Object.assign({ extends: ['plugin:@nrwl/nx/react', ...(pluginExtends || [])] }, config);
};
