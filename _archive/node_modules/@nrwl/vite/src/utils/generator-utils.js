...
function moveAndEditIndexHtml(tree, options, buildTarget) {
    ...
    var ref3;
    let mainPath = (ref3 = (ref1 = projectConfig.targets[buildTarget].options) == null ? void 0 : ref1.main) != null ? ref3 : `${projectConfig.root}/src/main.ts${options.uiFramework === 'react' ? 'x' : ''}`;
