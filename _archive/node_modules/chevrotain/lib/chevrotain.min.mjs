...
`+o)}return this.tokenizeInternal(t,r)}tokenizeInternal(t,r){let n,o,i,a,s,l,f,c,u,p,g,I,R,S,A,m,h=t,O=h.length,_=0,At=0,io=this.hasCustom?0:Math.floor(t.length/10),bt=new Array(io),ao=[],dr=this.trackStartLines?1:void 0,ve=this.trackStartLines?1:void 0,mr=El(this.emptyGroups),yf=this.trackStartLines,so=this.config.lineTerminatorsPattern,Wr=0,Jt=[],xr=[],Kr=[],ti=[];Object.freeze(ti);let gr;function ei(){return Jt}function ri(at){let yt=Kt(at),Le=xr[yt];return Le===void 0?ti:Le}let Sf=at=>{if(Kr.length===1&&at.tokenType.PUSH_MODE===void 0){let yt=this.config.errorMessageProvider.buildUnableToPopLexerModeMessage(at);ao.push({offset:at.startOffset,line:at.startLine,column:at.startColumn,length:at.image.length,message:yt})}else{Kr.pop();let yt=Gt(Kr);Jt=this.patternIdxToConfig[yt],xr=this.charCodeToPatternIdxToConfig[yt],Wr=Jt.length;let Le=this.canModeBeOptimized[yt]&&this.config.safeMode===!1;xr&&Le?gr=ri:gr=ei}};function ni(at){Kr.push(at),xr=this.charCodeToPatternIdxToConfig[at],Jt=this.patternIdxToConfig[at],Wr=Jt.length,Wr=Jt.length;let yt=this.canModeBeOptimized[at]&&this.config.safeMode===!1;xr&&yt?gr=ri:gr=ei}ni.call(this,r);let Nt,oi=this.config.recoveryEnabled;for(;_<O;){l=null;let at=h.charCodeAt(_),yt=gr(at),Le=yt.length;for(n=0;n<Le;n++){Nt=yt[n];let It=Nt.pattern;f=null;let jt=Nt.short;if(jt!==!1?at===jt&&(l=It):Nt.isCustom===!0?(m=It.exec(h,_,bt,mr),m!==null?(l=m[0],m.payload!==void 0&&(f=m.payload)):l=null):(this.updateLastIndex(It,_),l=this.match(It,t,_)),l!==null){if(s=Nt.longerAlt,s!==void 0){let Qt=s.length;for(i=0;i<Qt;i++){let $t=Jt[s[i]],Te=$t.pattern;if(c=null,$t.isCustom===!0?(m=Te.exec(h,_,bt,mr),m!==null?(a=m[0],m.payload!==void 0&&(c=m.payload)):a=null):(this.updateLastIndex(Te,_),a=this.match(Te,t,_)),a&&a.length>l.length){l=a,f=c,Nt=$t;break}}}break}}if(l!==null){if(u=l.length,p=Nt.group,p!==void 0&&(g=Nt.tokenTypeIdx,I=this.createTokenInstance(l,_,g,Nt.tokenType,dr,ve,u),this.handlePayload(I,f),p===!1?At=this.addToken(bt,At,I):mr[p].push(I)),t=this.chopInput(t,u),_=_+u,ve=this.computeNewColumn(ve,u),yf===!0&&Nt.canLineTerminator===!0){let It=0,jt,Qt;so.lastIndex=0;do jt=so.test(l),jt===!0&&(Qt=so.lastIndex-1,It++);while(jt===!0);It!==0&&(dr=dr+It,ve=u-Qt,this.updateTokenEndLineColumnLocation(I,p,Qt,It,dr,ve,u))}this.handleModes(Nt,Sf,ni,I)}else{let It=_,jt=dr,Qt=ve,$t=oi===!1;for(;$t===!1&&_<O;)for(t=this.chopInput(t,1),_++,o=0;o<Wr;o++){let Te=Jt[o],lo=Te.pattern,ii=Te.short;if(ii!==!1?h.charCodeAt(_)===ii&&($t=!0):Te.isCustom===!0?$t=lo.exec(h,_,bt,mr)!==null:(this.updateLastIndex(lo,_),$t=lo.exec(t)!==null),$t===!0)break}if(R=_-It,A=this.config.errorMessageProvider.buildUnexpectedCharactersMessage(h,It,R,jt,Qt),ao.push({offset:It,line:jt,column:Qt,length:R,message:A}),oi===!1)break}}return this.hasCustom||(bt.length=At),{tokens:bt,groups:mr,errors:ao}}handleModes(t,r,n,o){if(t.pop===!0){let i=t.push;r(o),i!==void 0&&n.call(this,i)}else t.push!==void 0&&n.call(this,t.push)}chopInput(t,r){return t.substring(r)}updateLastIndex(t,r){t.lastIndex=r}updateTokenEndLineColumnLocation(t,r,n,o,i,a,s){let l,f;r!==void 0&&(l=n===s-1,f=l?-1:0,o===1&&l===!0||(t.endLine=i+f,t.endColumn=a-1+-f))}computeNewColumn(t,r){return t+r}createOffsetOnlyToken(t,r,n,o){return{image:t,startOffset:r,tokenTypeIdx:n,tokenType:o}}createStartOnlyToken(t,r,n,o,i,a){return{image:t,startOffset:r,startLine:i,startColumn:a,tokenTypeIdx:n,tokenType:o}}createFullToken(t,r,n,o,i,a,s){return{image:t,startOffset:r,endOffset:r+s-1,startLine:i,endLine:i,startColumn:a,endColumn:a+s-1,tokenTypeIdx:n,tokenType:o}}addTokenUsingPush(t,r,n){return t.push(n),r}addTokenUsingMemberAccess(t,r,n){return t[r]=n,r++,r}handlePayloadNoCustom(t,r){}handlePayloadWithCustom(t,r){r!==null&&(t.payload=r)}matchWithTest(t,r,n){return t.test(r)===!0?r.substring(n,t.lastIndex):null}matchWithExec(t,r){let n=t.exec(r);return n!==null?n[0]:null}};it.SKIPPED="This marks a skipped Token pattern, this means each token identified by it willbe consumed and then thrown into oblivion, this can be used to for example to completely ignore whitespace.";it.NA=/NOT_APPLICABLE/;function _e(e){return Lo(e)?e.LABEL:e.name}function pT(e){return e.name}function Lo(e){return et(e.LABEL)&&e.LABEL!==""}var hT="parent",vl="categories",Ll="label",bl="group",Pl="push_mode",kl="pop_mode",Ml="longer_alt",wl="line_breaks",Fl="start_chars_hint";function bn(e){return dT(e)}function dT(e){let t=e.pattern,r={};if(r.name=e.name,ft(t)||(r.PATTERN=t),T(e,hT))throw`The parent property is no longer supported.
See: https://github.com/chevrotain/chevrotain/issues/564#issuecomment-349062346 for details.`;return T(e,vl)&&(r.CATEGORIES=e[vl]),Zt([r]),T(e,Ll)&&(r.LABEL=e[Ll]),T(e,bl)&&(r.GROUP=e[bl]),T(e,kl)&&(r.POP_MODE=e[kl]),T(e,Pl)&&(r.PUSH_MODE=e[Pl]),T(e,Ml)&&(r.LONGER_ALT=e[Ml]),T(e,wl)&&(r.LINE_BREAKS=e[wl]),T(e,Fl)&&(r.START_CHARS_HINT=e[Fl]),r}var vt=bn({name:"EOF",pattern:it.NA});Zt([vt]);function Ne(e,t,r,n,o,i,a,s){return{image:t,startOffset:r,endOffset:n,startLine:o,endLine:i,startColumn:a,endColumn:s,tokenTypeIdx:e.tokenTypeIdx,tokenType:e}}function bo(e,t){return qt(e,t)}var Pn={buildMismatchTokenMessage({expected:e,actual:t,previous:r,ruleName:n}){return`Expecting ${Lo(e)?`--> ${_e(e)} <--`:`token of type --> ${e.name} <--`} but found --> '${t.image}' <--`},buildNotAllInputParsedMessage({firstRedundant:e,ruleName:t}){return"Redundant input, expecting EOF but found: "+e.image},buildNoViableAltMessage({expectedPathsPerAlt:e,actual:t,previous:r,customUserDescription:n,ruleName:o}){let i="Expecting: ",s=`
...
but found: '`+ot(t).image+"'";if(r)return o+r+a;{let l=`expecting at least one iteration which starts with one of these possible Token sequences::
  <${d(e,f=>`[${d(f,c=>_e(c)).join(",")}]`).join(" ,")}>`;return o+l+a}}};Object.freeze(Pn);var Ul={buildRuleNotFoundError(e,t){return"Invalid grammar, reference to a rule which is not defined: ->"+t.nonTerminalName+`<-
