...
Historical Maxi self-check fixtures live in `ops/fixtures/synth/maxi/parity-metrics.json`. Active parity gates use Tone reference (`ops/fixtures/synth/wasm/parity-metrics-tone.json`) and Daisy drum fixtures (`ops/fixtures/synth/wasm/parity-metrics-daisy.json`).
