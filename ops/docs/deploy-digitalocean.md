...
The shared implementation is [`tasks/implementations/deploy/vm-zss-docker-run.sh`](../../tasks/implementations/deploy/vm-zss-docker-run.sh) (also `yarn task run deploy:vm:docker-run`).
