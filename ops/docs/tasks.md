...
| `yarn task run ops:fixtures:wanix:findplayers:build` | Build findplayers gojs scanner into ops/public/wanix/ only (needs Go + submodules/wanix — run ops:fixtures:wanix:toolchains first) | — | — | — |
