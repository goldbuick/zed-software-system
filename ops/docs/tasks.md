...
| `yarn task run ops:fixtures:wanix:p9server:dev` | Serve a folder over wss:// 9P for #wanix remote connect / zedsync (TLS via cafe mkcert; optional dir argv; default ops/fixtures/wanix/p9server/serve-root). Opens the folder in Finder. Ctrl+C to stop. | `dev` | — | — |
