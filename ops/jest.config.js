...
var CORPUS_SCREENSHOTS_TEST = '<rootDir>/ops/tests/integration/zzt/corpus-screenshots.test.ts';
var config = {
    rootDir: '..',
    ...
    moduleNameMapper: {
        ...
        '^zss/perf/ticktimingstats$': '<rootDir>/ops/lib/test/mocks/ticktimingstats.ts',
