...
export const DRUM_PARITY_PATCHES: DRUM_PARITY_PATCH[] = [
  ...
  { id: 'drum10-crash', notation: 'q10', durationsec: 0.75 },
  { id: 'drum11-ride', notation: 'q11', durationsec: 0.75 },
]
