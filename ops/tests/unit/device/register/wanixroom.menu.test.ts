...
jest.mock('zss/device/register/handlers/wanix/wanixtermbuffer', () => ({
  readwanixtermbufferkeys: jest.fn(() => []),
}))

jest.mock('zss/device/register/handlers/wanix/wanixdisplay', () => ({
...
import { applywanixroom, readwanixmenustate } from 'zss/device/register/handlers/wanix/wanixroom'
