...
describe('wanixhandleshownenu', () => {
  ...
  it('renders task and vm sections', async () => {
    ...
    expect(tape).toContain('wanixattach hello-wasm')
    expect(tape).toContain('wanixstop hello-wasm')
    expect(tape).toContain('wanixattach linux-vm')
    expect(tape).toContain('wanixvmstop linux-vm')
