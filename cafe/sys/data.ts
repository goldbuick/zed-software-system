  ...
  realms: {
    ...
    nodes: [
      ...
      },
      {
        ...
        label: 'stubspace',
        definition:
          'Join-mode stub VM (no clock/tick); replaces sim when /join/ URL; boardrunner still eager.',
        audience: 'Dev',
  ...
  tick: {
    ...
    nodes: [
      ...
      },
      {
        id: 'loaders',
        label: 'loaders',
        definition: 'Loader codepage execution each tick.',
        audience: 'Dev',
