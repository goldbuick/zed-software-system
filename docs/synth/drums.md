...
|---------|---------------------|
| **DaisySP WASM** (active) | Custom Maxi/Tone-parity bodies for all kit drums including tom (saw/tri/noise glide) and multi-harmonic bass; modal cymbals for crash/ride |
