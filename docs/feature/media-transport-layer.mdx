---
title: Media transport layer (PeerJS)
---
...
| Which messages cross PeerJS vs worker bridge | [`zss/device/docs/devices-and-messaging.mdx`](../../device/docs/devices-and-messaging.mdx) |
| Web broadcast capture sources (canvas + synth) and IVS ingest | [web-broadcast-livekit.mdx](../../../ops/docs/web-broadcast-livekit.mdx), [`zss/device/bridge.ts`](../../device/bridge.ts) (`bridge:streamstart` / `bridge:streamstop`) |
...
ZSS intends to use the **same conceptual capture sources** as today’s in-app **`#broadcast`** path (see [web-broadcast-livekit.mdx](../../../ops/docs/web-broadcast-livekit.mdx)):
...
- Deep LiveKit / IVS migration content (link [web-broadcast-livekit.mdx](../../../ops/docs/web-broadcast-livekit.mdx) only for “how capture works today”).
