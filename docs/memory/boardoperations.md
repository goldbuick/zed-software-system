...
| Board / object create, delete, import / export | [`boardlifecycle.ts`](../boardlifecycle.ts) — `memorycreateboard`, `memorycreateboardobject`, `memorycreateboardobjectfromkind`, `memorydeleteboardobject`, `memorysafedeleteelement`, `memorywriteterrain`, `memorywriteterrainfromkind`, `memoryreadgroup`, `memorylistboardelementsbygroup`, `memoryelementisingroup`, `memoryelementmatchesstrgroup`, `memoryelementmatchesstrgrouponboard`, `memoryexportboard(asjson)`, `memoryimportboard` |
