---
title: Web broadcast → LiveKit migration (ZSS)
---
...
This aligns with server-side Ingress setup and with multi-hop flows such as [LiveKit Ingress WHIP → YouTube Live](./livekit-ingress-whip-youtube-live.mdx) (room → egress → RTMP).
...
- [LiveKit Ingress (WHIP) → YouTube Live](./livekit-ingress-whip-youtube-live.mdx) — Ingress, egress, and YouTube RTMP.
