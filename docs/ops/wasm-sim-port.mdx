---
title: "WASM C++ port: game sim and execution"
---
...
- [Multiplayer, workers, PeerJS, and WASM](multiplayer-wasm-architecture.mdx)
- [ZSS architecture (current)](../../zss/ARCHITECTURE.md)
- [Lang pipeline (today)](../../zss/feature/lang/docs/architecture.mdx)
...
| Docs | This file + [multiplayer-wasm-architecture.mdx](multiplayer-wasm-architecture.mdx) |
...
There is **no bytecode today**; the port introduces a new IR. See [lang architecture](../../zss/feature/lang/docs/architecture.mdx) for the current JS pipeline.
...
See [multiplayer-wasm-architecture.mdx](multiplayer-wasm-architecture.mdx) for host + 2 joins.
