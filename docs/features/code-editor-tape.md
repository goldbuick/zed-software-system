...
| Parse error messages | Creator | Chevrotain errors rewritten to short hints in editor and compile tape. | [`zss/feature/lang/docs/formatlangerror.md`](/docs/lang/formatlangerror) |
